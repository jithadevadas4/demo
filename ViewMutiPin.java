...
import com.aumento.there_level_atm_security.Adapters.MultiAdapter;
...
public class ViewMutiPin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_muti_pin);
    ...
    public void showlist(String s) {
        try {
            ...
            RvItem = (RecyclerView) findViewById(R.id.rv_mitem);
